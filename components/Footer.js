          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                { icon: <FaXTwitter />, link: "https://x.com/AI1Team/" },
                { icon: <FaInstagram />, link: "https://www.instagram.com/ai1team.automation.agency/" },
                { icon: <FaFacebook />, link: "https://www.facebook.com/profile.php?id=61589291811206/" }
              ].map((social, index) => (
                <a
                  key={index}
                  href={social.link}
