    ...
    <section className="bg-[#F0F6FF] py-16 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-[#555577] text-sm leading-relaxed mb-8 max-w-md mx-auto text-center">
            Not ready to book a call yet? Send us a message and we&apos;ll get back to you within 24 hours.
          </p>
